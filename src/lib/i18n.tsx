...
export const translations: Record<Language, Record<TranslationKey, string>> = {
  en: {
    ...
    "filter.clear": "Clear All",
     ...
     "dashboard.assistant.subtitle": "Rule-based help with your account, estimates, and market data.",
   ...
   am: {
    ...
    "filter.clear": "ሁሉንም ሰርዝ",
     ...
     "dashboard.assistant.subtitle": "በመረጽዎ መረጃ የተመሠረተ ምክር — መለያዎ፣ ግምቶች እና የገበያ መረጃ።",
