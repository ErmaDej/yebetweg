...
4. **Post-launch** (optional): BOQ share permalink (`/boq/:id`), chart lib consolidation, analytics dashboard, expand test coverage to hooks/pages. Phase 5 progress: freshness cron automation ✓, Telegram /submitprice funnel ✓, multi-city BOQ from market_prices ✓, **Pro export ✓ + BOQ→actuals ✓ (Sep 21)**, assistant intelligence upgrade ✓ (Sep 21) — remaining: save-to-project polish.
